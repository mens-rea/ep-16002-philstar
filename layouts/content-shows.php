...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="container content-body">
					...
					<div class="title-line"></div>
								...
								<div class="sections">
									<div class="col-xs-12">
										<a class="series-subtitle-link" href="<?php the_permalink(); ?>"><h3 class="series-subtitle animated fadeInUp wow"><?php the_title(); ?> &raquo;</h3></a>
										<h4 class="series-subtitle-episodes">Episodes</h4>
										...
										<?php 
											if (is_array(get_field('season_episodes')) || is_object(get_field('season_episodes')))
											{
												...
												<a href="#" data-featherlight='<iframe src="//player.vimeo.com/video/<?php echo $row2['episode_link']; ?>?autoplay=1" width="960" height="540" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'>
													<div class="col-xs-12 col-sm-6 col-md-4 home-list animated-slow<?php echo $pst_ctr; ?> animated fadeInUp wow">
															...
															<div class="col-xs-7 col-sm-12 col-md-12 ep-list-content white-container">
																<h4><?php echo $row2['episode_name']; ?> <?php the_field('series_schedule'); ?></h4>
																<h4>12pm</h4>
															</div>
													</div>
												</a>
									...
									<div class="col-xs-12">
										<a class="btn-orange btn-center" href="<?php echo get_category_link(get_field('main_series')); ?>"> View All Episodes</a>
									</div>
								</div>
